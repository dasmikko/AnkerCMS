...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/media/website/css/main.css">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">AnkerDesigns</a>
        </div>
        <div class="navbar-collapse collapse">
         ...
         <!--  <button type="submit" class="btn btn-danger navbar-btn btn-sm navbar-right">Logout</button> -->
          ...
          <a href="/login" class="btn btn-primary navbar-btn btn-sm navbar-right">Login</a>
          @endif
        </div><!--/.navbar-collapse -->
      </div>
    </div>
